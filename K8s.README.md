...
kubectl create secret docker-registry gcr-json-key --docker-server=northamerica-northeast1-docker
.pkg.dev --docker-username=_json_key --docker-password="$(cat /home/ceos/projects/microservices-dev-432918-b64bdbe4b63c.json)" --docker-email=ceosmore@gmail.com
